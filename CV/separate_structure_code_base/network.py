...
class ResNet(nn.Module):
    def __init__(self, img_H=224, img_W=224, in_chans=3):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(in_channels=in_chans, out_channels=128, kernel_size=5, stride=1, padding=2), nn.ReLU())
        self.maxpool1 = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Sequential(nn.Conv2d(in_channels=128, out_channels=128, kernel_size=5, stride=1, padding=2), nn.ReLU())
